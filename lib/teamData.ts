...
* 🇳🇬 Goleada da Nigéria por **4x0 sobre Benin**
  👉 Resultado: África do Sul assume a liderança e garante a vaga! 🏆🔥`,
    ...
    players: [
      { name: 'Ronwen Williams', position: 'Goleiro' },
      { name: 'Ricardo Goss', position: 'Goleiro' },
      { name: 'Sipho Chaine', position: 'Goleiro' },
      { name: 'Khuliso Mudau', position: 'Defensor' },
      { name: 'Nkosinathi Sibisi', position: 'Defensor' },
      { name: 'Ime Okon', position: 'Defensor' },
      { name: 'Khulumani Ndamane', position: 'Defensor' },
      { name: 'Aubrey Modiba', position: 'Defensor' },
      { name: 'Samukelo Kabini', position: 'Defensor' },
      { name: 'Thabang Matuludi', position: 'Defensor' },
      { name: 'Olwethu Makhanya', position: 'Defensor' },
      { name: 'Kamogelo Sebelebele', position: 'Defensor' },
      { name: 'Bradley Cross', position: 'Defensor' },
      { name: 'Mbekezeli Mbokazi', position: 'Defensor' },
      { name: 'Teboho Mokoena', position: 'Atacante' },
      { name: 'Thalente Mbatha', position: 'Atacante' },
      { name: 'Sphephelo Sithole', position: 'Atacante' },
      { name: 'Jayden Adams', position: 'Atacante' },
      { name: 'Oswin Appollis', position: 'Atacante' },
      { name: 'Iqraam Rayners', position: 'Atacante' },
      { name: 'Tshepang Moremi', position: 'Atacante' },
      { name: 'Relebohile Mofokeng', position: 'Atacante' },
      { name: 'Evidence Makgopa', position: 'Atacante' },
      { name: 'Themba Zwane', position: 'Atacante' },
      { name: 'Lyle Foster', position: 'Atacante' },
      { name: 'Thapelo Maseko', position: 'Atacante' }
    ],
    historyStats: {
      participations: 4,
      totalMatches: 9,
...
Cabo Verde chega como grande surpresa do torneio. Com organização tática e espírito coletivo forte, pode ser uma das zebras da Copa.`,
    ...
    players: [
      { name: 'Josimar Dias', position: 'Goleiro' },
      { name: 'Márcio da Rosa', position: 'Goleiro' },
      { name: 'Carlos Santos', position: 'Goleiro' },
      { name: 'Steven Moreira', position: 'Defensor' },
      { name: 'Wagner Pina', position: 'Defensor' },
      { name: 'Sidny Cabral', position: 'Defensor' },
      { name: 'Logan Costa', position: 'Defensor' },
      { name: 'Roberto Lopes', position: 'Defensor' },
      { name: 'Kelvin Pires', position: 'Defensor' },
      { name: 'Ianique Tavares', position: 'Defensor' },
      { name: 'Edilson Borges', position: 'Defensor' },
      { name: 'Jamiro Monteiro', position: 'Atacante' },
      { name: 'Deroy Duarte', position: 'Atacante' },
      { name: 'Kevin Pina', position: 'Atacante' },
      { name: 'Laros Duarte', position: 'Atacante' },
      { name: 'Telmo Arcanjo', position: 'Atacante' },
      { name: 'Yannick Semedo', position: 'Atacante' },
      { name: 'João Paulo Fernandes', position: 'Atacante' },
      { name: 'Garry Rodrigues', position: 'Atacante' },
      { name: 'Jovane Cabral', position: 'Atacante' },
      { name: 'Ryan Mendes', position: 'Atacante' },
      { name: 'Nuno da Costa', position: 'Atacante' },
      { name: 'Dailon Livramento', position: 'Atacante' },
      { name: 'Gilson Benchimol', position: 'Atacante' },
      { name: 'Willy Semedo', position: 'Atacante' },
      { name: 'Hélio Varela', position: 'Atacante' }
    ],
    historyStats: {
      participations: 1,
      totalMatches: 0,
...
A meta é clara: voltar ao mata-mata, algo que não acontece desde 1994.`,
    ...
    players: [
      { name: 'Ahmed Al Kassar', position: 'Goleiro' },
      { name: 'Mohammed Al Owais', position: 'Goleiro' },
      { name: 'Nawaf Al Aqidi', position: 'Goleiro' },
      { name: 'Saud Abdulhamid', position: 'Defensor' },
      { name: 'Mohammed Abu Al Shamat', position: 'Defensor' },
      { name: 'Khalid Al Ghannam', position: 'Defensor' },
      { name: 'Moteb Al Harbi', position: 'Defensor' },
      { name: 'Abdulelah Al Amri', position: 'Defensor' },
      { name: 'Nawaf Boushal', position: 'Defensor' },
      { name: 'Hassan Kadesh', position: 'Defensor' },
      { name: 'Ali Lajami', position: 'Defensor' },
      { name: 'Ali Majrashi', position: 'Defensor' },
      { name: 'Hassan Tambakti', position: 'Defensor' },
      { name: 'Jehad Thikri', position: 'Defensor' },
      { name: 'Nasser Al Dawsari', position: 'Atacante' },
      { name: 'Alaa Al Hajji', position: 'Atacante' },
      { name: 'Ziyad Al Johani', position: 'Atacante' },
      { name: 'Musab Al Juwayr', position: 'Atacante' },
      { name: 'Abdullah Al Khaibari', position: 'Atacante' },
      { name: 'Mohammed Kanno', position: 'Atacante' },
      { name: 'Sultan Mandash', position: 'Atacante' },
      { name: 'Ayman Yahya', position: 'Atacante' },
      { name: 'Feras Al Brikan', position: 'Atacante' },
      { name: 'Salem Al Dawsari', position: 'Atacante' },
      { name: 'Abdullah Al Hamdan', position: 'Atacante' },
      { name: 'Saleh Al Shehri', position: 'Atacante' }
    ],
    historyStats: {
      participations: 7,
      totalMatches: 19,
...
👉 Uma equipe que mistura tradição, raça e ambição.`,
    ...
    players: [
      ...
      { name: 'Santiago Mele', position: 'Goleiro' },
      { name: 'Guillermo Varela', position: 'Defensor' },
      { name: 'Ronald Araujo', position: 'Defensor' },
      { name: 'José María Giménez', position: 'Defensor' },
      { name: 'Santiago Bueno', position: 'Defensor' },
      { name: 'Sebastián Cáceres', position: 'Defensor' },
      { name: 'Mathías Olivera', position: 'Defensor' },
      { name: 'Joaquín Piquerez', position: 'Defensor' },
      { name: 'Matías Viña', position: 'Defensor' },
      { name: 'Manuel Ugarte', position: 'Atacante' },
      { name: 'Emiliano Martínez', position: 'Atacante' },
      { name: 'Rodrigo Bentancur', position: 'Atacante' },
      { name: 'Federico Valverde', position: 'Atacante' },
      { name: 'Agustín Canobbio', position: 'Atacante' },
      { name: 'Juan Manuel Sanabria', position: 'Atacante' },
      { name: 'Giorgian De Arrascaeta', position: 'Atacante' },
      { name: 'Nicolás de la Cruz', position: 'Atacante' },
      { name: 'Rodrigo Zalazar', position: 'Atacante' },
      { name: 'Facundo Pellistri', position: 'Atacante' },
      { name: 'Maximiliano Araújo', position: 'Atacante' },
      { name: 'Brian Rodríguez', position: 'Atacante' },
      { name: 'Rodrigo Aguirre', position: 'Atacante' },
      { name: 'Federico Viñas', position: 'Atacante' },
...
O Brasil garantiu sua vaga nas Eliminatórias Sul-Americanas, terminando entre os primeiros colocados após uma campanha sólida, apesar de alguns tropeços no início do ciclo sob novo comando técnico.`,
    ...
    players: [
      ...
      { name: 'Douglas Santos', position: 'Defensor' },
      { name: 'Gabriel Magalhães', position: 'Defensor' },
      { name: 'Ibañez', position: 'Defensor' },
      { name: 'Léo Pereira', position: 'Defensor' },
      { name: 'Marquinhos', position: 'Defensor' },
      { name: 'Wesley', position: 'Defensor' },
      { name: 'Bruno Guimarães', position: 'Atacante' },
      { name: 'Casemiro', position: 'Atacante' },
      { name: 'Danilo Santos', position: 'Atacante' },
      { name: 'Fabinho', position: 'Atacante' },
      { name: 'Lucas Paquetá', position: 'Atacante' },
...
* **Principais Conquistas:** Campeão da Copa América (2021, 2024), Finalissima (2022) e Copa do Mundo (2022).`,
    ...
    players: [
      ...
      { name: 'Gerónimo Rulli', position: 'Goleiro' },
      { name: 'Juan Musso', position: 'Goleiro' },
      { name: 'Nahuel Molina', position: 'Defensor' },
      { name: 'Gonzalo Montiel', position: 'Defensor' },
      { name: 'Cuti Romero', position: 'Defensor' },
      { name: 'Otamendi', position: 'Defensor' },
      { name: 'Lisandro Martínez', position: 'Defensor' },
      { name: 'Leonardo Balerdi', position: 'Defensor' },
      { name: 'Nicolás Tagliafico', position: 'Defensor' },
      { name: 'Facundo Medina', position: 'Defensor' },
      { name: 'De Paul', position: 'Atacante' },
      { name: 'Enzo Fernández', position: 'Atacante' },
      { name: 'Paredes', position: 'Atacante' },
      { name: 'Mac Allister', position: 'Atacante' },
      { name: 'Valentín Barco', position: 'Atacante' },
      { name: 'Lo Celso', position: 'Atacante' },
      { name: 'Exequiel Palacios', position: 'Atacante' },
      { name: 'Thiago Almada', position: 'Atacante' },
      { name: 'Nico Paz', position: 'Atacante' },
      { name: 'Lionel Messi', position: 'Atacante' },
      { name: 'Nico González', position: 'Atacante' },
      { name: 'Giuliano Simeone', position: 'Atacante' },
      { name: 'Flaco Lopez', position: 'Atacante' },
...
* **Principais Conquistas:** Conduziu a Suíça a campanhas sólidas em Eurocopas e Copas do Mundo, sendo reconhecido por sua organização tática.`,
    ...
    players: [
      { name: 'Luca Zidane', position: 'Goleiro' },
      { name: 'Oussama Benbot', position: 'Goleiro' },
      { name: 'Melvin Mastil', position: 'Goleiro' },
      { name: 'Abdelatif Ramdane', position: 'Goleiro' },
      { name: 'Rafik Belghali', position: 'Defensor' },
      { name: 'Samir Chergui', position: 'Defensor' },
      { name: 'Rayan Ait-Nouri', position: 'Defensor' },
      { name: 'Jaouen Hadjam', position: 'Defensor' },
      { name: 'Aissa Mandi', position: 'Defensor' },
      { name: 'Ramy Bensebaini', position: 'Defensor' },
      { name: 'Zineddine Belaid', position: 'Defensor' },
      { name: 'Achref Abada', position: 'Defensor' },
      { name: 'Mohamed Amine Tougai', position: 'Defensor' },
      { name: 'Nabil Bentaleb', position: 'Atacante' },
      { name: 'Hicham Boudaqui', position: 'Atacante' },
      { name: 'Houssem Aouar', position: 'Atacante' },
      { name: 'Farès Chaibi', position: 'Atacante' },
      { name: 'Ibrahim Maza', position: 'Atacante' },
      { name: 'Yacine Titraoui', position: 'Atacante' },
      { name: 'Ramiz Zerrouki', position: 'Atacante' },
      { name: 'Mohamed Amine Amoura', position: 'Atacante' },
      { name: 'Nadhir Benbouali', position: 'Atacante' },
      { name: 'Adil Boulbina', position: 'Atacante' },
      { name: 'Farès Ghedjemis', position: 'Atacante' },
      { name: 'Amine Gouri', position: 'Atacante' },
      { name: 'Anis Hadj Moussa', position: 'Atacante' },
      { name: 'Riyad Mahrez', position: 'Atacante' }
    ],
    historyStats: {
      participations: 5,
      totalMatches: 13,
...
* **Principais Conquistas:** Pioneiro do *Gegenpressing*, influenciou gerações de treinadores alemães e transformou o estilo de jogo da Áustria com intensidade e pressão alta.`,
    ...
    players: [
      { name: 'Alexander Schlager', position: 'Goleiro' },
      { name: 'Florian Wiegele', position: 'Goleiro' },
      { name: 'Patrick Pentz', position: 'Goleiro' },
      { name: 'David Affengruber', position: 'Defensor' },
      { name: 'Kevin Danso', position: 'Defensor' },
      { name: 'Stefan Posch', position: 'Defensor' },
      { name: 'David Alaba', position: 'Defensor' },
      { name: 'Philipp Lienhart', position: 'Defensor' },
      { name: 'Phillipp Mwene', position: 'Defensor' },
      { name: 'Alexander Prass', position: 'Defensor' },
      { name: 'Marco Friedl', position: 'Defensor' },
      { name: 'Michael Svoboda', position: 'Defensor' },
      { name: 'Xaver Schlager', position: 'Atacante' },
      { name: 'Nicolas Seiwald', position: 'Atacante' },
      { name: 'Marcel Sabitzer', position: 'Atacante' },
      { name: 'Florian Grillitsch', position: 'Atacante' },
      { name: 'Carney Chukwuemeka', position: 'Atacante' },
      { name: 'Romano Schmid', position: 'Atacante' },
      { name: 'Christoph Baumgartner', position: 'Atacante' },
      { name: 'Konrad Laimer', position: 'Atacante' },
      { name: 'Patrick Wimmer', position: 'Atacante' },
      { name: 'Paul Wanner', position: 'Atacante' },
      { name: 'Alessandro Schopf', position: 'Atacante' },
      { name: 'Marko Arnautović', position: 'Atacante' },
      { name: 'Michael Gregoritsch', position: 'Atacante' },
      { name: 'Sasa Kalajdzic', position: 'Atacante' }
    ],
    historyStats: {
      participations: 8,
      totalMatches: 29,
...
* **Principais Conquistas:** Vencedor do CHAN (Campeonato das Nações Africanas) com o Marrocos, é elogiado por sua disciplina tática e capacidade de extrair o máximo de seus elencos.`,
    ...
    players: [
      { name: 'Yazeed Abu Laila', position: 'Goleiro' },
      { name: 'Abdullah Al-Fakhouri', position: 'Goleiro' },
      { name: 'Nour Bani Attiah', position: 'Goleiro' },
      { name: 'Abdallah Nasib', position: 'Defensor' },
      { name: 'Saed Al-Rosan', position: 'Defensor' },
      { name: 'Yazan Al-Arab', position: 'Defensor' },
      { name: 'Saleem Obaid', position: 'Defensor' },
      { name: 'Mohammad Abualnadi', position: 'Defensor' },
      { name: 'Husam Abu Dahab  Ihsan Haddad', position: 'Defensor' },
      { name: 'Anas Badawi', position: 'Defensor' },
      { name: 'Mohannad Abu Taha', position: 'Defensor' },
      { name: 'Mohammad Abu Hashish', position: 'Defensor' },
      { name: 'Nour Al-Rawabdeh', position: 'Atacante' },
      { name: 'Nizar Al-Rashdan', position: 'Atacante' },
      { name: 'Ibrahim Sadeh', position: 'Atacante' },
      { name: 'Rajaei Ayed', position: 'Atacante' },
      { name: 'Odeh Fakhouri', position: 'Atacante' },
      { name: 'Amer Jamous', position: 'Atacante' },
      { name: 'Mohammad Al-Dawoud', position: 'Atacante' },
      { name: 'Mahmoud Al-Mardi', position: 'Atacante' },
      { name: 'Musa Al-Taamari', position: 'Atacante' },
      { name: 'Mohammad Abu Zrayq', position: 'Atacante' },
      { name: 'Ali Al-Azaizeh', position: 'Atacante' },
      { name: 'Ibrahim Sabra', position: 'Atacante' },
      { name: 'Ali Olwan', position: 'Atacante' }
    ],
    historyStats: {
      participations: 1,
      totalMatches: 0,
...
A França chega como candidata ao título e quer fazer história com mais uma final.`,
    ...
    players: [
      { name: 'Mike Maignan', position: 'Goleiro' },
      { name: 'Robin Risser', position: 'Goleiro' },
      { name: 'Brice Samba', position: 'Goleiro' },
      { name: 'Lucas Digne', position: 'Defensor' },
      { name: 'Malo Gusto', position: 'Defensor' },
      { name: 'Lucas Hernández', position: 'Defensor' },
      { name: 'Theo Hernandez', position: 'Defensor' },
      { name: 'Ibrahima Konaté', position: 'Defensor' },
      { name: 'Jules Koundé', position: 'Defensor' },
      { name: 'Maxence Lacroix', position: 'Defensor' },
      { name: 'William Saliba', position: 'Defensor' },
      { name: 'Dayot Upamecano', position: 'Defensor' },
      { name: 'N\'Golo Kanté', position: 'Atacante' },
      { name: 'Manu Koné', position: 'Atacante' },
      { name: 'Adrien Rabiot', position: 'Atacante' },
      { name: 'Aurélien Tchouaméni', position: 'Atacante' },
      { name: 'Warren Zaïre-Emery', position: 'Atacante' },
      { name: 'Maghnes Akliouche', position: 'Atacante' },
      { name: 'Bradley Barcola', position: 'Atacante' },
      { name: 'Rayan Cherki', position: 'Atacante' },
      { name: 'Ousmane Dembélé', position: 'Atacante' },
      { name: 'Désiré Doué', position: 'Atacante' },
      { name: 'Jean-Philippe Mateta', position: 'Atacante' },
      { name: 'Kylian Mbappé', position: 'Atacante' },
      { name: 'Michael Olise', position: 'Atacante' },
...
O Iraque chega como azarão, mas com espírito de luta forte para surpreender.`,
    ...
    players: [
      { name: 'Jalal Hassan', position: 'Goleiro' },
      { name: 'Ahmed Basil', position: 'Goleiro' },
      { name: 'Fahad Talib', position: 'Goleiro' },
      { name: 'Mirkhas Doski', position: 'Defensor' },
      { name: 'Ahmed Yahya', position: 'Defensor' },
      { name: 'Manaf Younis', position: 'Defensor' },
      { name: 'Akam Hashim', position: 'Defensor' },
      { name: 'Zaid Tahsin', position: 'Defensor' },
      { name: 'Rebin Sulaka', position: 'Defensor' },
      { name: 'Frans Putros', position: 'Defensor' },
      { name: 'Hussein Ali', position: 'Defensor' },
      { name: 'Mustafa Saadoun', position: 'Defensor' },
      { name: 'Aimar Sher', position: 'Atacante' },
      { name: 'Zaid Ismail', position: 'Atacante' },
      { name: 'Amir Al-Ammari', position: 'Atacante' },
      { name: 'Kevin Yaqoub', position: 'Atacante' },
      { name: 'Zidane Iqbal', position: 'Atacante' },
      { name: 'Ahmed Qasim', position: 'Atacante' },
      { name: 'Ibrahim Bayesh', position: 'Atacante' },
      { name: 'Ali Jassim', position: 'Atacante' },
      { name: 'Yousef Amin', position: 'Atacante' },
      { name: 'Marco Faraj', position: 'Atacante' },
      { name: 'Ali Al-Hamadi', position: 'Atacante' },
      { name: 'Aymen Hussein', position: 'Atacante' },
      { name: 'Mohanad Ali', position: 'Atacante' },
      { name: 'Ali Youssef', position: 'Atacante' }
    ],
    historyStats: {
      participations: 2,
      totalMatches: 3,
...
Senegal chega forte para brigar por vaga no mata-mata e repetir 2002.`,
    ...
    players: [
      ...
      { name: 'Mory Diaw', position: 'Goleiro' },
      { name: 'Yehvann Diouf', position: 'Goleiro' },
      { name: 'Krépin Diatta', position: 'Defensor' },
      { name: 'Antoine Mendy', position: 'Defensor' },
      { name: 'Kalidou Koulibaly', position: 'Defensor' },
      { name: 'El Hadji Malich Diouf', position: 'Defensor' },
      { name: 'Mamadou Sarr', position: 'Defensor' },
      { name: 'Moussa Niakhaté', position: 'Defensor' },
      { name: 'Moustapha Mbow', position: 'Defensor' },
      { name: 'Abdoulaye Seck', position: 'Defensor' },
      { name: 'Ismail Jakobs', position: 'Defensor' },
      { name: 'Ilay Camara', position: 'Defensor' },
      { name: 'Idrissa Gana Gueye', position: 'Atacante' },
      { name: 'Pape Gueye', position: 'Atacante' },
      { name: 'Lamine Camara', position: 'Atacante' },
      { name: 'Habib Diarra', position: 'Atacante' },
      { name: 'Pathé Ciss', position: 'Atacante' },
      { name: 'Pape Matar Sarr', position: 'Atacante' },
      { name: 'Bara Sapoko Ndiaye', position: 'Atacante' },
      { name: 'Sadio Mané', position: 'Atacante' },
      { name: 'Ismaila Sarr', position: 'Atacante' },
      { name: 'Iliman Ndiaye', position: 'Atacante' },
      { name: 'Assane Diao', position: 'Atacante' },
      { name: 'Ibrahim Mbaye', position: 'Atacante' },
      { name: 'Nicolas Jackson', position: 'Atacante' },
      { name: 'Bamba Dieng', position: 'Atacante' },
      { name: 'Chérif Ndiaye', position: 'Atacante' }
    ],
    historyStats: {
      participations: 4,
      totalMatches: 12,
...
👉 Objetivo: avançar e fazer sua melhor campanha da história.`,
    ...
    players: [
      { name: 'Egil Selvik', position: 'Goleiro' },
      { name: 'Orjan Nyland', position: 'Goleiro' },
      { name: 'Sander Tangvik', position: 'Goleiro' },
      { name: 'Kristoffer Ajer', position: 'Defensor' },
      { name: 'Fredrik Bjorkan', position: 'Defensor' },
      { name: 'Henrik Falchener', position: 'Defensor' },
      { name: 'Sondre Langas', position: 'Defensor' },
      { name: 'Torbjorn Heggem', position: 'Defensor' },
      { name: 'Holmgren Pedersen', position: 'Defensor' },
      { name: 'Julian Ryerson', position: 'Defensor' },
      { name: 'Leo Ostigard', position: 'Defensor' },
      { name: 'David Moller', position: 'Atacante' },
      { name: 'Martin Odegaard', position: 'Atacante' },
      { name: 'Patrick Berg', position: 'Atacante' },
      { name: 'Kristian Thorstvedt', position: 'Atacante' },
      { name: 'Thelo Aasgaard', position: 'Atacante' },
      { name: 'Fredrik Aursnes', position: 'Atacante' },
      { name: 'Sander Berge', position: 'Atacante' },
      { name: 'Morten Thorsby', position: 'Atacante' },
      { name: 'Strand Larsen', position: 'Atacante' },
      { name: 'Oscar Bobb', position: 'Atacante' },
      { name: 'Erling Haaland', position: 'Atacante' },
      { name: 'Andreas Schjelderup', position: 'Atacante' },
      { name: 'Jens Petter Hauge', position: 'Atacante' },
      { name: 'Antonio Nusa', position: 'Atacante' },
      { name: 'Alexander Sorloth', position: 'Atacante' }
    ],
    historyStats: {
      participations: 4,
      totalMatches: 8,
...
* 🛡️ **Solidez Total:** A equipe garantiu a vaga com muita antecedência, mostrando um equilíbrio perfeito entre posse de bola e eficiência defensiva.`,
    ...
    players: [
      ...
      { name: 'David Raya', position: 'Goleiro' },
      { name: 'Joan García', position: 'Goleiro' },
      { name: 'Cucurella', position: 'Defensor' },
      { name: 'Grimaldo', position: 'Defensor' },
      { name: 'Cubarsí', position: 'Defensor' },
      { name: 'Laporte', position: 'Defensor' },
      { name: 'Pubill', position: 'Defensor' },
      { name: 'Eric García', position: 'Defensor' },
      { name: 'Marcos Llorente', position: 'Defensor' },
      { name: 'Pedro Porro', position: 'Defensor' },
      { name: 'Pedri', position: 'Atacante' },
      { name: 'Fabián Ruíz', position: 'Atacante' },
      { name: 'Zubimendi', position: 'Atacante' },
      { name: 'Gavi', position: 'Atacante' },
      { name: 'Rodri', position: 'Atacante' },
      { name: 'Alex Baena', position: 'Atacante' },
      { name: 'Merino', position: 'Atacante' },
      { name: 'Oyarzabal', position: 'Atacante' },
      { name: 'Dani Olmo', position: 'Atacante' },
      { name: 'Nico Williams', position: 'Atacante' },
      { name: 'Yeremy Pino', position: 'Atacante' },
      { name: 'Ferran Torres', position: 'Atacante' },
      { name: 'Borja Iglesias', position: 'Atacante' },
      { name: 'Víctor Muñoz', position: 'Atacante' },
      { name: 'Lamine Yamal', position: 'Atacante' }
    ],
    historyStats: {
      participations: 17,
      totalMatches: 67,
...
A Alemanha busca apagar as últimas decepções e voltar ao topo do mundo com um futebol ofensivo e renovado!`,
    ...
    players: [
      { name: 'Oliver Baumann', position: 'Goleiro' },
      { name: 'Manuel Neuer', position: 'Goleiro' },
      { name: 'Alexander Nubel', position: 'Goleiro' },
      { name: 'Waldemar Anton', position: 'Defensor' },
      { name: 'Nathaniel Brown', position: 'Defensor' },
      { name: 'Pascal Gross', position: 'Defensor' },
      { name: 'Joshua Kimmich', position: 'Defensor' },
      { name: 'Felix Nmecha', position: 'Defensor' },
      { name: 'Aleksandar Pavlovic', position: 'Defensor' },
      { name: 'David Raum', position: 'Defensor' },
      { name: 'Antonio Rudiger', position: 'Defensor' },
      { name: 'Nico Schlotterbeck', position: 'Defensor' },
      { name: 'Angelo Stiller', position: 'Defensor' },
      { name: 'Jonathan Tah', position: 'Defensor' },
      { name: 'Malick Thiaw', position: 'Defensor' },
      { name: 'Nadiem Amiri', position: 'Atacante' },
      { name: 'Maximilian Beier', position: 'Atacante' },
      { name: 'Leon Goretzka', position: 'Atacante' },
      { name: 'Kai Havertz', position: 'Atacante' },
      { name: 'Lennart Karl', position: 'Atacante' },
      { name: 'Jamie Leweling', position: 'Atacante' },
      { name: 'Jamal Musiala', position: 'Atacante' },
      { name: 'Leroy Sané', position: 'Atacante' },
      { name: 'Deniz Undav', position: 'Atacante' },
      { name: 'Florian Wirtz', position: 'Atacante' },
      { name: 'Nick Woltemade', position: 'Atacante' }
    ],
    historyStats: {
      participations: 21,
      totalMatches: 112,
...
* Retorno ao papel de anfitrião após 1994`,
    ...
    players: [
      { name: 'Chris Brady', position: 'Goleiro' },
      { name: 'Matt Freese', position: 'Goleiro' },
      { name: 'Matt Turner', position: 'Goleiro' },
      { name: 'Alex Freeman', position: 'Defensor' },
      { name: 'Antonee Robinson', position: 'Defensor' },
      { name: 'Auston Trusty', position: 'Defensor' },
      { name: 'Chris Richards', position: 'Defensor' },
      { name: 'Mark McKenzie', position: 'Defensor' },
      { name: 'Max Arfsten', position: 'Defensor' },
      { name: 'Sergiño Dest', position: 'Defensor' },
      { name: 'Tim Ream', position: 'Defensor' },
      { name: 'Miles Robinson', position: 'Defensor' },
      { name: 'Joe Scally', position: 'Defensor' },
      { name: 'Sergiño Dest', position: 'Defensor' },
      { name: 'Brenden Aaronson', position: 'Atacante' },
      { name: 'Cristian Roldan', position: 'Atacante' },
      { name: 'Gio Reyna', position: 'Atacante' },
      { name: 'Malik Tillman', position: 'Atacante' },
      { name: 'Tyler Adams', position: 'Atacante' },
      { name: 'Weston McKennie', position: 'Atacante' },
      { name: 'Alex Zendejas', position: 'Atacante' },
      { name: 'Christian Pulisic', position: 'Atacante' },
      { name: 'Folarin Balogun', position: 'Atacante' },
      { name: 'Haji Wright', position: 'Atacante' },
      { name: 'Ricardo Pepi', position: 'Atacante' },
      { name: 'Tim Weah', position: 'Atacante' }
    ],
    historyStats: {
      participations: 12,
      totalMatches: 37,
...
A meta é clara: superar a "maldição das oitavas" e buscar uma semifinal inédita em casa! 💪🇲🇽`,
    ...
    players: [
      { name: 'Raúl Rangel', position: 'Goleiro' },
      { name: 'Carlos Acevedo', position: 'Goleiro' },
      { name: 'Guillermo Ochoa', position: 'Goleiro' },
      { name: 'Jorge Sánchez', position: 'Defensor' },
      { name: 'César Montes', position: 'Defensor' },
      { name: 'Edson Álvarez', position: 'Defensor' },
      { name: 'Joah Vásquez', position: 'Defensor' },
      { name: 'Erik Lira', position: 'Defensor' },
      { name: 'Luis Romo', position: 'Defensor' },
      { name: 'Israel Reyes', position: 'Defensor' },
      { name: 'Mateo Chávez', position: 'Defensor' },
      { name: 'Jesús Gallardo', position: 'Defensor' },
      { name: 'Álvaro Fidalgo', position: 'Atacante' },
      { name: 'Orbelín Pineda', position: 'Atacante' },
      { name: 'Obed Vargas', position: 'Atacante' },
      { name: 'Gilberto Mora', position: 'Atacante' },
      { name: 'César Huerta', position: 'Atacante' },
      { name: 'Luis Chávez', position: 'Atacante' },
      { name: 'Roberto Alvarado', position: 'Atacante' },
      { name: 'Brian Gutiérrez', position: 'Atacante' },
      { name: 'Raúl Jiménez', position: 'Atacante' },
      { name: 'Alexis Veja', position: 'Atacante' },
      { name: 'Santiago Giménez', position: 'Atacante' },
      { name: 'Armando González', position: 'Atacante' },
      { name: 'Julián Quiñones', position: 'Atacante' },
      { name: 'Guillermo Martínez', position: 'Atacante' }
    ],
    historyStats: {
      participations: 18,
      totalMatches: 60,
...
* 🔥 Grande oportunidade de crescimento no futebol mundial`,
    ...
    players: [
      { name: 'Dayne St. Clair', position: 'Goleiro' },
      { name: 'Maxim Crépeau', position: 'Goleiro' },
      { name: 'Owen Goodman', position: 'Goleiro' },
      { name: 'Alistair Johnston', position: 'Defensor' },
      { name: 'Derek Cornelius', position: 'Defensor' },
      { name: 'Richie Laryea', position: 'Defensor' },
      { name: 'Kiko Sigur', position: 'Defensor' },
      { name: 'Joel Waterman', position: 'Defensor' },
      { name: 'Luc de Fougerolles', position: 'Defensor' },
      { name: 'Moise Bombito', position: 'Defensor' },
      { name: 'Alfie Jones', position: 'Defensor' },
      { name: 'Alphonso Davies', position: 'Defensor' },
      { name: 'Stephen Eustáquio', position: 'Atacante' },
      { name: 'Ismael Koné', position: 'Atacante' },
      { name: 'Tajon Buchanan', position: 'Atacante' },
      { name: 'Mathieu Choinière', position: 'Atacante' },
      { name: 'Ali Ahmed', position: 'Atacante' },
      { name: 'Nathan Saliba', position: 'Atacante' },
      { name: 'Liam Millar', position: 'Atacante' },
      { name: 'Marcelo Flores', position: 'Atacante' },
      { name: 'Jacob Shaffelburg', position: 'Atacante' },
      { name: 'Jonathan Osorio', position: 'Atacante' },
      { name: 'Jonathan David', position: 'Atacante' },
      { name: 'Cyle Larin', position: 'Atacante' },
      { name: 'Tani Oluwaseyi', position: 'Atacante' },
      { name: 'Promise David', position: 'Atacante' }
    ],
    historyStats: {
      participations: 3,
      totalMatches: 6,
...
A campanha da Coreia do Sul foi marcada por consistência e força no cenário asiático, garantindo sua vaga com autoridade! 💪🇰🇷`,
    ...
    players: [
      { name: 'Kim Seunggyu', position: 'Goleiro' },
      { name: 'Song Bumkeun', position: 'Goleiro' },
      { name: 'Jo Hyeonwoo', position: 'Goleiro' },
      { name: 'Kim Moonhwan', position: 'Defensor' },
      { name: 'Kim Min-jae', position: 'Defensor' },
      { name: 'Kim Taehyeon', position: 'Defensor' },
      { name: 'Park Jinseob', position: 'Defensor' },
      { name: 'Seol Youngwoo', position: 'Defensor' },
      { name: 'Jens Castrop', position: 'Defensor' },
      { name: 'Lee Kihyuk', position: 'Defensor' },
      { name: 'Lee Taeseok', position: 'Defensor' },
      { name: 'Lee Hanbeom', position: 'Defensor' },
      { name: 'Cho Yumin', position: 'Defensor' },
      { name: 'Kim Jingyu', position: 'Atacante' },
      { name: 'Bae Junho', position: 'Atacante' },
      { name: 'Paik Seungho', position: 'Atacante' },
      { name: 'Yang Hyunjun', position: 'Atacante' },
      { name: 'Eom Jisung', position: 'Atacante' },
      { name: 'Lee Kang-in', position: 'Atacante' },
      { name: 'Lee Donggyeong', position: 'Atacante' },
      { name: 'Lee Jaesung', position: 'Atacante' },
      { name: 'Hwang Inbeom', position: 'Atacante' },
      { name: 'Hwang Heechan', position: 'Atacante' },
      { name: 'Son Heung-min', position: 'Atacante' },
      { name: 'Oh Hyeongyu', position: 'Atacante' },
...
A jornada até a Copa foi marcada por **emoção e nervos de aço** 😮🔥`,
    ...
    players: [
      { name: 'Lukáš Horníček', position: 'Goleiro' },
      { name: 'Matěj Kovář', position: 'Goleiro' },
      { name: 'Jindřich Staněk', position: 'Goleiro' },
      { name: 'Vladimír Coufal', position: 'Defensor' },
      { name: 'David Douděra', position: 'Defensor' },
      { name: 'Tomáš Holeš', position: 'Defensor' },
      { name: 'Robin Hranáč', position: 'Defensor' },
      { name: 'Štěpán Chaloupek', position: 'Defensor' },
      { name: 'David Jurásek', position: 'Defensor' },
      { name: 'Ladislav Krejčí', position: 'Defensor' },
      { name: 'Jaroslav Zelený', position: 'Defensor' },
      { name: 'David Zima', position: 'Defensor' },
      { name: 'Lukáš Červ', position: 'Meio-campista' },
      { name: 'Vladimír Darida', position: 'Meio-campista' },
      { name: 'Lukáš Provod', position: 'Meio-campista' },
      { name: 'Michal Sadílek', position: 'Meio-campista' },
      { name: 'Hugo Sochůrek', position: 'Meio-campista' },
      { name: 'Alexandr Sojka', position: 'Meio-campista' },
      { name: 'Tomáš Souček', position: 'Meio-campista' },
      { name: 'Pavel Šulc', position: 'Meio-campista' },
      { name: 'Denis Višinský', position: 'Meio-campista' },
      { name: 'Adam Hložek', position: 'Atacante' },
      { name: 'Tomáš Chorý', position: 'Atacante' },
      { name: 'Mojmír Chytil', position: 'Atacante' },
      { name: 'Patrik Schick', position: 'Atacante' },
      { name: 'Jan Kuchta', position: 'Atacante' }
    ],
    historyStats: {
      participations: 10,
      totalMatches: 33,
...
Mesmo sem classificação direta, o Catar mostrou **força mental e evolução competitiva** 💥`,
    ...
    players: [
      { name: 'Mahmoud Abunada', position: 'Goleiro' },
      { name: 'Meshaal Barsham', position: 'Goleiro' },
      { name: 'Salah Zakaria', position: 'Goleiro' },
      { name: 'Ayoub Al-Alawi', position: 'Defensor' },
      { name: 'Boualem Khoukhi', position: 'Defensor' },
      { name: 'Homam Al-Amin', position: 'Defensor' },
      { name: 'Lucas Mendes', position: 'Defensor' },
      { name: 'Issa Laye', position: 'Defensor' },
      { name: 'Pedro Miguel', position: 'Defensor' },
      { name: 'Al-Hashmi Al-Hussain', position: 'Defensor' },
      { name: 'Sultan Al-Brake', position: 'Defensor' },
      { name: 'Assim Madibo', position: 'Atacante' },
      { name: 'Abdulaziz Hatem', position: 'Atacante' },
      { name: 'Ahmed Fathy', position: 'Atacante' },
      { name: 'Karim Boudiaf', position: 'Atacante' },
      { name: 'Jassem Gaber', position: 'Atacante' },
      { name: 'Mohamed Mannaj  Ahmed Al-Ganehi', position: 'Atacante' },
      { name: 'Ahmed Alaa', position: 'Atacante' },
      { name: 'Akram Afif', position: 'Atacante' },
      { name: 'AlMoez Ali', position: 'Atacante' },
      { name: 'Edmilson Junior', position: 'Atacante' },
      { name: 'Hasan Al-Haydos', position: 'Atacante' },
      { name: 'Mohammed Muntari', position: 'Atacante' },
      { name: 'Tahsin Mohammed', position: 'Atacante' },
      { name: 'Youssef Abdulrazzaq', position: 'Atacante' }
    ],
    historyStats: {
      participations: 2,
      totalMatches: 3,
...
Uma seleção equilibrada, sólida e pronta para surpreender! 💪🇨🇭`,
    ...
    players: [
      { name: 'Marvin Keller', position: 'Goleiro' },
      { name: 'Gregor Kobel', position: 'Goleiro' },
      { name: 'Yvon Mvogo', position: 'Goleiro' },
      { name: 'Manuel Akanji', position: 'Defensor' },
      { name: 'Aurèle Amenda', position: 'Defensor' },
      { name: 'Eray Comert', position: 'Defensor' },
      { name: 'Nico Elvedi', position: 'Defensor' },
      { name: 'Luca Jaquez', position: 'Defensor' },
      { name: 'Miro Muheim', position: 'Defensor' },
      { name: 'Ricardo Rodriguez', position: 'Defensor' },
      { name: 'Silvan Widmer', position: 'Defensor' },
      { name: 'Michel Aebischer', position: 'Atacante' },
      { name: 'Zeki Amdouni', position: 'Atacante' },
      { name: 'Breel Embolo', position: 'Atacante' },
      { name: 'Christian Fassnacht', position: 'Atacante' },
      { name: 'Remo Freuler', position: 'Atacante' },
      { name: 'Cedric Itten', position: 'Atacante' },
      { name: 'Ardon Jashari', position: 'Atacante' },
      { name: 'Johan Manzambi', position: 'Atacante' },
      { name: 'Dan Ndoye', position: 'Atacante' },
      { name: 'Noah Okafor', position: 'Atacante' },
      { name: 'Fabian Rieder', position: 'Atacante' },
      { name: 'Djibril Sow', position: 'Atacante' },
      { name: 'Ruben Vargas', position: 'Atacante' },
      { name: 'Grant Xhaka', position: 'Atacante' },
      { name: 'Denis Zakaria', position: 'Atacante' }
    ],
    historyStats: {
      participations: 13,
      totalMatches: 41,
...
Agora, retorna ao Mundial com mais experiência e ambição! 💪🇧🇦`,
    ...
    players: [
      { name: 'Nikola Vasilj', position: 'Goleiro' },
      { name: 'Martin Zlomislic', position: 'Goleiro' },
      { name: 'Osman Hadzikic', position: 'Goleiro' },
      { name: 'Sead Kolasinac', position: 'Defensor' },
      { name: 'Amar Dedic', position: 'Defensor' },
      { name: 'Nihad Mujakic', position: 'Defensor' },
      { name: 'Nikola Katic', position: 'Defensor' },
      { name: 'Tarik Muharemovic', position: 'Defensor' },
      { name: 'Stjepan Radeljic', position: 'Defensor' },
      { name: 'Dennis Hadzikadunic', position: 'Atacante' },
      { name: 'Nidal Celik', position: 'Atacante' },
      { name: 'Amir Hadziahmetovic', position: 'Atacante' },
      { name: 'Ivan Sunjic', position: 'Atacante' },
      { name: 'Ivan Basic', position: 'Atacante' },
      { name: 'Dzenis Burnic', position: 'Atacante' },
      { name: 'Benjamin Tahirovic', position: 'Atacante' },
      { name: 'Amar Memic', position: 'Atacante' },
      { name: 'Armin Gigovic', position: 'Atacante' },
      { name: 'Kerim Alajbegovic', position: 'Atacante' },
      { name: 'Esmir Bajraktarevic', position: 'Atacante' },
      { name: 'Ermin Mahmic', position: 'Atacante' },
      { name: 'Ermedin Demirovic', position: 'Atacante' },
      { name: 'Jovo Lukic', position: 'Atacante' },
      { name: 'Samed Bazdar', position: 'Atacante' },
      { name: 'Haris Tabakovic', position: 'Atacante' },
      { name: 'Edin Dzeko', position: 'Atacante' }
    ],
    historyStats: {
      participations: 2,
      totalMatches: 3,
...
* Terminou como líder do Grupo E da CAF com ampla vantagem`,
    ...
    players: [
      { name: 'Bounou', position: 'Goleiro' },
      { name: 'El Kajoui', position: 'Goleiro' },
      { name: 'Tagnaouti', position: 'Goleiro' },
      { name: 'Mazraoui', position: 'Defensor' },
      { name: 'Salah-Eddine', position: 'Defensor' },
      { name: 'Belammari', position: 'Defensor' },
      { name: 'Hakimi', position: 'Defensor' },
      { name: 'El Ouahdi', position: 'Defensor' },
      { name: 'Aguerd', position: 'Defensor' },
      { name: 'Riad', position: 'Defensor' },
      { name: 'Halhal', position: 'Defensor' },
      { name: 'Diop', position: 'Defensor' },
      { name: 'El Mourabet', position: 'Atacante' },
      { name: 'Bouaddi', position: 'Atacante' },
      { name: 'El Aynaoui', position: 'Atacante' },
      { name: 'Amrabat', position: 'Atacante' },
      { name: 'Ounahi', position: 'Atacante' },
      { name: 'El Khannouss', position: 'Atacante' },
      { name: 'Saibari  Ez Abde', position: 'Atacante' },
      { name: 'Talbi', position: 'Atacante' },
      { name: 'Rahimi', position: 'Atacante' },
      { name: 'El Kaabi', position: 'Atacante' },
      { name: 'Brahim Díaz', position: 'Atacante' },
      { name: 'Gessime', position: 'Atacante' },
      { name: 'Echghouyabe', position: 'Atacante' }
    ],
    historyStats: {
      participations: 7,
      totalMatches: 23,
...
➡️ Resultado: **1º lugar do grupo e vaga garantida na Copa**`,
    ...
    players: [
      { name: 'Johnny Placide', position: 'Goleiro' },
      { name: 'Alexandre Pierre', position: 'Goleiro' },
      { name: 'Josué Duverger', position: 'Goleiro' },
      { name: 'Carlens Arcus', position: 'Defensor' },
      { name: 'Wilguens Pauguain', position: 'Defensor' },
      { name: 'Duke Lacroix', position: 'Defensor' },
      { name: 'Martin Experience', position: 'Defensor' },
      { name: 'JK Duverne', position: 'Defensor' },
      { name: 'Ricardo Ade', position: 'Defensor' },
      { name: 'Hannes Delcroix', position: 'Defensor' },
      { name: 'Keeto Thermoncy', position: 'Defensor' },
      { name: 'Leverton Pierre', position: 'Atacante' },
      { name: 'Carl-Fred Sainthe', position: 'Atacante' },
      { name: 'Jean-Jacques Danley', position: 'Atacante' },
      { name: 'Jeanricner Bellegarde', position: 'Atacante' },
      { name: 'Pierre Woodenski', position: 'Atacante' },
      { name: 'Dominique Simon', position: 'Atacante' },
      { name: 'Louicius Deedson', position: 'Atacante' },
      { name: 'Ruben Providence', position: 'Atacante' },
      { name: 'Josué Casimir', position: 'Atacante' },
      { name: 'Derrick Etienne', position: 'Atacante' },
      { name: 'Wilson Isidor', position: 'Atacante' },
      { name: 'Duckens Nazon', position: 'Atacante' },
      { name: 'Frantzdy Pierrot', position: 'Atacante' },
      { name: 'Yassin Fortune', position: 'Atacante' },
      { name: 'Lenny Joseph', position: 'Atacante' }
    ],
    historyStats: {
      participations: 2,
      totalMatches: 3,
...
👉 Dois gols saíram nos acréscimos, garantindo uma classificação histórica.`,
    ...
    players: [
      { name: 'Craig Gordon', position: 'Goleiro' },
      { name: 'Angus Gunn', position: 'Goleiro' },
      { name: 'Liam Kelly', position: 'Goleiro' },
      { name: 'Grant Hanley', position: 'Defensor' },
      { name: 'Jack Hendry', position: 'Defensor' },
      { name: 'Aaron Hickey', position: 'Defensor' },
      { name: 'Dom Hyam', position: 'Defensor' },
      { name: 'Soctt McKenna', position: 'Defensor' },
      { name: 'Nathan Patterson', position: 'Defensor' },
      { name: 'Anthony Ralston', position: 'Defensor' },
      { name: 'Andy Robertson', position: 'Defensor' },
      { name: 'John Souttar', position: 'Defensor' },
      { name: 'Kieran Tierney', position: 'Defensor' },
      { name: 'Ryan Christie', position: 'Atacante' },
      { name: 'Findlay Curtis', position: 'Atacante' },
      { name: 'Lewis Fergunson', position: 'Atacante' },
      { name: 'Ben Gannon-Doak', position: 'Atacante' },
      { name: 'Billy Gilmour', position: 'Atacante' },
      { name: 'John McGinn', position: 'Atacante' },
      { name: 'Kenny McLean', position: 'Atacante' },
      { name: 'Scott McTominay', position: 'Atacante' },
      { name: 'Che Adams', position: 'Atacante' },
      { name: 'Lyndon Dykes', position: 'Atacante' },
      { name: 'George Hirst', position: 'Atacante' },
      { name: 'Lawrence Shankland', position: 'Atacante' },
      { name: 'Ross Steward', position: 'Atacante' }
    ],
    historyStats: {
      participations: 9,
      totalMatches: 23,
...
➡️ Garantiu vaga direta no Mundial de 2026`,
    ...
    players: [
      { name: 'Orlando Gill', position: 'Goleiro' },
      { name: 'Gatito Fernández', position: 'Goleiro' },
      { name: 'Gastón Olveira', position: 'Goleiro' },
      { name: 'Juan Cáceres', position: 'Defensor' },
      { name: 'José Canale', position: 'Defensor' },
      { name: 'Fabián Balbuena', position: 'Defensor' },
      { name: 'Omar Alderete', position: 'Defensor' },
      { name: 'Gustavo Gómez', position: 'Defensor' },
      { name: 'Alexandro Maidana', position: 'Defensor' },
      { name: 'Junior Alonso', position: 'Defensor' },
      { name: 'Gustavo Velázquez', position: 'Defensor' },
      { name: 'Braian Ojeda', position: 'Atacante' },
      { name: 'Damián Bobadilla', position: 'Atacante' },
      { name: 'Andrés Cubas', position: 'Atacante' },
      { name: 'Diego Gómez', position: 'Atacante' },
      { name: 'Alejandro Romero Gamarra', position: 'Atacante' },
      { name: 'Mauricio', position: 'Atacante' },
      { name: 'Matías Galarza', position: 'Atacante' },
      { name: 'Gustavo Caballero', position: 'Atacante' },
      { name: 'Ramón Sosa', position: 'Atacante' },
      { name: 'Miguel Almirón', position: 'Atacante' },
      { name: 'Gabriel Ávalos', position: 'Atacante' },
      { name: 'Isidro Pitta', position: 'Atacante' },
      { name: 'Álex Arce', position: 'Atacante' },
      { name: 'Julio Enciso', position: 'Atacante' },
      { name: 'Antonio Sanabria', position: 'Atacante' }
    ],
    historyStats: {
      participations: 9,
      totalMatches: 27,
...
➡️ Classificação garantida com vaga direta para a Copa`,
    ...
    players: [
      { name: 'Patrick Beach', position: 'Goleiro' },
      { name: 'Paul Izzo', position: 'Goleiro' },
      { name: 'Maty Ryan', position: 'Goleiro' },
      { name: 'Aziz Behich', position: 'Defensor' },
      { name: 'Jordan Bos', position: 'Defensor' },
      { name: 'Cameron Burgess', position: 'Defensor' },
      { name: 'Alessandro Circati', position: 'Defensor' },
      { name: 'Milos Degenek', position: 'Defensor' },
      { name: 'Jason Geria', position: 'Defensor' },
      { name: 'Lucas Herrington', position: 'Defensor' },
      { name: 'Jacob Italiano', position: 'Defensor' },
      { name: 'Harry Souttar', position: 'Defensor' },
      { name: 'Kai Trewin', position: 'Defensor' },
      { name: 'Cameron Devlin', position: 'Atacante' },
      { name: 'Ajdin Hrustic', position: 'Atacante' },
      { name: 'Jackson Irvine', position: 'Atacante' },
      { name: 'Connor Metcalfe', position: 'Atacante' },
      { name: 'Paul Okon-Engstler', position: 'Atacante' },
      { name: 'Aiden O\'Neill', position: 'Atacante' },
      { name: 'Nestory Irankunda', position: 'Atacante' },
      { name: 'Mathew Leckie', position: 'Atacante' },
      { name: 'Awer Mabil', position: 'Atacante' },
      { name: 'Mohamed Toure', position: 'Atacante' },
      { name: 'Nishan Velupillay', position: 'Atacante' },
      { name: 'Cristian Volpato', position: 'Atacante' },
      { name: 'Tete Yengi', position: 'Atacante' }
    ],
    historyStats: {
      participations: 7,
      totalMatches: 20,
...
Mas Montella não deixou a peteca cair! O comandante conduziu sua equipe com sucesso na repescagem continental, garantindo a vaga com vitórias cirúrgicas sobre a **Romênia** 🇷🇴 e o **Kosovo** 🇽🇰. 💪`,
    ...
    players: [
      { name: 'Altay Bayindir', position: 'Goleiro' },
      { name: 'Mert Günok', position: 'Goleiro' },
      { name: 'Ugurcan Cakir', position: 'Goleiro' },
      { name: 'Abdulkerim Bardakci', position: 'Defensor' },
      { name: 'Caglar Soyuncu', position: 'Defensor' },
      { name: 'Eren Elmalı', position: 'Defensor' },
      { name: 'Ferdi Kadıoğlu', position: 'Defensor' },
      { name: 'Merih Demiral', position: 'Defensor' },
      { name: 'Mert Müldür', position: 'Defensor' },
      { name: 'Ozan Kabak', position: 'Defensor' },
      { name: 'Samet Akaydin', position: 'Defensor' },
      { name: 'Zeki Celik', position: 'Defensor' },
      { name: 'Hakan Calhanoglu', position: 'Atacante' },
      { name: 'Ismail Yuksek', position: 'Atacante' },
      { name: 'Kaan Ayhan', position: 'Atacante' },
      { name: 'Orkun Kökçü', position: 'Atacante' },
      { name: 'Salih Ozcan', position: 'Atacante' },
      { name: 'Arda Güler', position: 'Atacante' },
      { name: 'Barış Alper Yılmaz', position: 'Atacante' },
      { name: 'Can Uzun', position: 'Atacante' },
      { name: 'Deniz Gül', position: 'Atacante' },
      { name: 'Irfan Can Kahveci', position: 'Atacante' },
      { name: 'Kenan Yıldız', position: 'Atacante' },
      { name: 'Kerem Akturkoglu', position: 'Atacante' },
      { name: 'Oguz Aydin', position: 'Atacante' },
      { name: 'Yunus Akgun', position: 'Atacante' }
    ],
    historyStats: {
      participations: 3,
      totalMatches: 10,
...
* 🤝 Jamaica 0 x 0 Curaçau 🇯🇲 (O jogo da classificação!) 🎊`,
    ...
    players: [
      { name: 'Tyrick Bodak', position: 'Goleiro' },
      { name: 'Trevor Doornbusch', position: 'Goleiro' },
      { name: 'Eloy Room', position: 'Goleiro' },
      { name: 'Riechedly Bazoer', position: 'Defensor' },
      { name: 'Joshua Brenet', position: 'Defensor' },
      { name: 'Roshon Van Eijma', position: 'Defensor' },
      { name: 'Sherel Floranus', position: 'Defensor' },
      { name: 'Deveron Fonville', position: 'Defensor' },
      { name: 'Jurien Gaari', position: 'Defensor' },
      { name: 'Armando Obispo', position: 'Defensor' },
      { name: 'Shurandy Sambo', position: 'Defensor' },
      { name: 'Juninho Bacuna', position: 'Atacante' },
      { name: 'Leandro Bacuna', position: 'Atacante' },
      { name: 'Livano Comenencia', position: 'Atacante' },
      { name: 'Kevin Felida', position: 'Atacante' },
      { name: 'AR\'Jany Martha', position: 'Atacante' },
      { name: 'Tyrese Noslin', position: 'Atacante' },
      { name: 'Godfried Roemeratoe', position: 'Atacante' },
      { name: 'Jeremy Antonisse', position: 'Atacante' },
      { name: 'Tahith Chong', position: 'Atacante' },
      { name: 'Kenji Gorré', position: 'Atacante' },
      { name: 'Sontje Hansen', position: 'Atacante' },
      { name: 'Gervane Kastaneer', position: 'Atacante' },
      { name: 'Brandley Kuwas', position: 'Atacante' },
      { name: 'Jurgen Locadia', position: 'Atacante' },
      { name: 'Jearl Margaritha', position: 'Atacante' }
    ],
    historyStats: {
      participations: 1,
      totalMatches: 0,
...
* 🎯 **Artilharia Pesada:** O paredão do meio-campo Seko Fofana liderou com 3 gols, seguido de perto por nomes de peso como Franck Kessié, Simon Adingra e Sébastien Haller.`,
    ...
    players: [
      { name: 'Yahia Fofana', position: 'Goleiro' },
      { name: 'Mohamed Koné', position: 'Goleiro' },
      { name: 'Alban Lafont', position: 'Goleiro' },
      { name: 'Emmanuel Agbadou', position: 'Defensor' },
      { name: 'Clement Akpa', position: 'Defensor' },
      { name: 'Ousmane Diomande', position: 'Defensor' },
      { name: 'Guela Doue', position: 'Defensor' },
      { name: 'Ghislan Konan', position: 'Defensor' },
      { name: 'Odilon Kossounou', position: 'Defensor' },
      { name: 'Evan Ndicka', position: 'Defensor' },
      { name: 'Wilfried Singo', position: 'Defensor' },
      { name: 'Seko Fofana', position: 'Atacante' },
      { name: 'Parfait Guiagon', position: 'Atacante' },
      { name: 'Christ Inao Oulai', position: 'Atacante' },
      { name: 'Franck Kessie', position: 'Atacante' },
      { name: 'Ibrahim Sangare', position: 'Atacante' },
      { name: 'Jean-Mickael Seri', position: 'Atacante' },
      { name: 'Simon Adingra', position: 'Atacante' },
      { name: 'Ange-Yoan Bonny', position: 'Atacante' },
      { name: 'Amad Diallo', position: 'Atacante' },
      { name: 'Oumar Diakite', position: 'Atacante' },
      { name: 'Yan Diomande', position: 'Atacante' },
      { name: 'Evann Guessand', position: 'Atacante' },
      { name: 'Nicolas Pepe', position: 'Atacante' },
      { name: 'Bazoumana Toure', position: 'Atacante' },
      { name: 'Elye Wahi', position: 'Atacante' }
    ],
    historyStats: {
      participations: 4,
      totalMatches: 9,
...
* 🎯 **Matador:** O veterano Enner Valencia continua sendo a referência no ataque, tendo marcado 6 gols na caminhada classificatória.`,
    ...
    players: [
      { name: 'Hernán Galíndez', position: 'Goleiro' },
      { name: 'Moisés Ramírez', position: 'Goleiro' },
      { name: 'Gonzalo Valle', position: 'Goleiro' },
      { name: 'Willian Pacho', position: 'Defensor' },
      { name: 'Piero Hincapié', position: 'Defensor' },
      { name: 'Joel Ordóñez', position: 'Defensor' },
      { name: 'Jackson Porozo', position: 'Defensor' },
      { name: 'Félix Torres', position: 'Defensor' },
      { name: 'Pervis Estupiñán', position: 'Defensor' },
      { name: 'Yaimar Medina', position: 'Defensor' },
      { name: 'Ángelo Preciado', position: 'Defensor' },
      { name: 'Moisés Caicedo', position: 'Atacante' },
      { name: 'Jordy Alcívar', position: 'Atacante' },
      { name: 'Pedro Vite', position: 'Atacante' },
      { name: 'Denil Castillo', position: 'Atacante' },
      { name: 'Alan Franco', position: 'Atacante' },
      { name: 'Kendry Páez', position: 'Atacante' },
      { name: 'Nilson Angulo', position: 'Atacante' },
      { name: 'Gonzalo Plata', position: 'Atacante' },
      { name: 'John Yeboah', position: 'Atacante' },
      { name: 'Enner Valencia', position: 'Atacante' },
      { name: 'Jordy Caicedo', position: 'Atacante' },
      { name: 'Jeremy Arévalo', position: 'Atacante' },
      { name: 'Anthony Valencia', position: 'Atacante' },
      { name: 'Kevin Rodríguez', position: 'Atacante' }
    ],
    historyStats: {
      participations: 5,
      totalMatches: 13,
...
* 🤝 **Equilíbrio:** Os únicos pontos perdidos foram nos empates contra a forte seleção da Polônia 🇵🇱.`,
    ...
    players: [
      { name: 'Mark Flekken', position: 'Goleiro' },
      { name: 'Robin Roefs', position: 'Goleiro' },
      { name: 'Bart Verbruggen', position: 'Goleiro' },
      { name: 'Nathan Aké', position: 'Defensor' },
      { name: 'Virgil van Dijk', position: 'Defensor' },
      { name: 'Denzel Dumfries', position: 'Defensor' },
      { name: 'Jorrel Hato', position: 'Defensor' },
      { name: 'Jan Paul van Hecke', position: 'Defensor' },
      { name: 'Jurriën Timber', position: 'Defensor' },
      { name: 'Micky van de Ven', position: 'Defensor' },
      { name: 'Ryan Gravenberch', position: 'Meio-campista' },
      { name: 'Frenkie de Jong', position: 'Meio-campista' },
      { name: 'Teun Koopmeiners', position: 'Meio-campista' },
      { name: 'Tijjani Reijnders', position: 'Meio-campista' },
      { name: 'Marten de Roon', position: 'Meio-campista' },
      { name: 'Guus Til', position: 'Meio-campista' },
      { name: 'Quinten Timber', position: 'Meio-campista' },
      { name: 'Mats Wieffer', position: 'Meio-campista' },
      { name: 'Memphis Depay', position: 'Atacante' },
      { name: 'Brian Brobbey', position: 'Atacante' },
      { name: 'Cody Gakpo', position: 'Atacante' },
      { name: 'Justin Kluivert', position: 'Atacante' },
      { name: 'Noa Lang', position: 'Atacante' },
      { name: 'Donyell Malen', position: 'Atacante' },
      { name: 'Crysencio Summerville', position: 'Atacante' },
...
* 🚀 **Velocidade Máxima:** Na fase final, superou potências como a Arábia Saudita 🇸🇦 e carimbou a vaga com três rodadas de antecedência. Foi a classificação mais rápida da história do futebol japonês! 🎌💨`,
    ...
    players: [
      { name: 'Zion Suzuki', position: 'Goleiro' },
      { name: 'Keisuke Osako', position: 'Goleiro' },
      { name: 'Tomoki Hayakawa', position: 'Goleiro' },
      { name: '· Hiroki Ito', position: 'Defensor' },
      { name: 'Junnosuke Suzuki', position: 'Defensor' },
      { name: 'Ayumu Seko', position: 'Defensor' },
      { name: 'Shogo Taniguchi', position: 'Defensor' },
      { name: 'Tsuyoshi Watanabe', position: 'Defensor' },
      { name: 'Ko Itakura', position: 'Defensor' },
      { name: 'Takehiro Tomiyasu', position: 'Defensor' },
      { name: 'Yukinari Sugawara', position: 'Defensor' },
      { name: 'Yuto Nagatomo', position: 'Defensor' },
      { name: '· Daichi Kamada', position: 'Atacante' },
      { name: 'Ao Tanaka', position: 'Atacante' },
      { name: 'Kaishu Sano', position: 'Atacante' },
      { name: 'Wataru Endo', position: 'Atacante' },
      { name: 'Keito Nakamura', position: 'Atacante' },
      { name: 'Daizen Maeda', position: 'Atacante' },
      { name: 'Ritsu Doan', position: 'Atacante' },
      { name: 'Yuito Suzuki', position: 'Atacante' },
      { name: 'Junya Ito', position: 'Atacante' },
      { name: 'Ayase Ueda', position: 'Atacante' },
      { name: 'Koki Ogawa', position: 'Atacante' },
      { name: 'Kento Shiogai', position: 'Atacante' },
      { name: 'Keisuke Goto', position: 'Atacante' },
      { name: 'Takefusa Kubo', position: 'Atacante' }
    ],
    historyStats: {
      participations: 8,
      totalMatches: 25,
...
* ✅ **Vaga Carimbada:** Vitórias épicas sobre a Ucrânia 🇺🇦 (3x1) e Polônia 🇵🇱 (3x2) garantiram o passaporte em março de 2026!`,
    ...
    players: [
      { name: 'Viktor Johansson', position: 'Goleiro' },
      { name: 'Kristoffer Nordfeldt', position: 'Goleiro' },
      { name: 'Jacob Widell Zetterström', position: 'Goleiro' },
      { name: 'Hjalmar Ekdal', position: 'Defensor' },
      { name: 'Gabriel Gudmundsson', position: 'Defensor' },
      { name: 'Isak Hien', position: 'Defensor' },
      { name: 'Emil Holm', position: 'Defensor' },
      { name: 'Gustaf Lagerbielke', position: 'Defensor' },
      { name: 'Victor Nilsson Lindelöf', position: 'Defensor' },
      { name: 'Eric Smith', position: 'Defensor' },
      { name: 'Carl Starfelt', position: 'Defensor' },
      { name: 'Elliot Stroud', position: 'Defensor' },
      { name: 'Daniel Svensson', position: 'Defensor' },
      { name: 'Taha Ali', position: 'Atacante' },
      { name: 'Yasin Ayari', position: 'Atacante' },
      { name: 'Lucas Bergvall', position: 'Atacante' },
      { name: 'Alexander Bernhardsson', position: 'Atacante' },
      { name: 'Anthony Elanga', position: 'Atacante' },
      { name: 'Viktor Gyökeres', position: 'Atacante' },
      { name: 'Alexander Isak', position: 'Atacante' },
      { name: 'Jesper Karlström', position: 'Atacante' },
      { name: 'Gustaf Nilsson', position: 'Atacante' },
      { name: 'Benjamin Nygren', position: 'Atacante' },
      { name: 'Ken Sema', position: 'Atacante' },
      { name: 'Mattias Svanberg', position: 'Atacante' },
      { name: 'Besfort Zeneli', position: 'Atacante' }
    ],
    historyStats: {
      participations: 13,
      totalMatches: 51,
...
* 🎯 **O Gol da Glória:** A vaga foi selada oficialmente com um gol heroico de Mohamed Ali Ben Romdhane nos minutos finais contra a Guiné Equatorial 🇬🇶. 🎊🙌`,
    ...
    players: [
      { name: 'Dahmen', position: 'Goleiro' },
      { name: 'Chamakh', position: 'Goleiro' },
      { name: 'Ben Hassen', position: 'Goleiro' },
      { name: 'Valery', position: 'Defensor' },
      { name: 'Neffati', position: 'Defensor' },
      { name: 'Bronn', position: 'Defensor' },
      { name: 'Talbi', position: 'Defensor' },
      { name: 'Rekik', position: 'Defensor' },
      { name: 'Arous', position: 'Defensor' },
      { name: 'Chikhaoui', position: 'Defensor' },
      { name: 'Abdi', position: 'Defensor' },
      { name: 'Ben Hmida', position: 'Defensor' },
      { name: 'Skhiri', position: 'Atacante' },
      { name: 'Mahmoud', position: 'Atacante' },
      { name: 'Khedira', position: 'Atacante' },
      { name: 'Ben Silmane', position: 'Atacante' },
      { name: 'Ben Ouanes', position: 'Atacante' },
      { name: 'Gharbi', position: 'Atacante' },
      { name: 'Hannibal', position: 'Atacante' },
      { name: 'Ayari', position: 'Atacante' },
      { name: 'Achouri', position: 'Atacante' },
      { name: 'Saad', position: 'Atacante' },
      { name: 'Chaouat', position: 'Atacante' },
      { name: 'Mastoui', position: 'Atacante' },
      { name: 'Elloumi', position: 'Atacante' },
      { name: 'Tonekti', position: 'Atacante' }
    ],
    historyStats: {
      participations: 7,
      totalMatches: 18,
...
* 🛡️ **Superação:** O time mostrou resiliência após um período de transição, garantindo presença em solo norte-americano com méritos totais.`,
    ...
    players: [
      { name: 'Courtois', position: 'Goleiro' },
      { name: 'Lammens', position: 'Goleiro' },
      { name: 'Mike Penders', position: 'Goleiro' },
      { name: 'Timothy Castagne', position: 'Defensor' },
      { name: 'Zeno Debast', position: 'Defensor' },
      { name: 'Koni De Winter', position: 'Defensor' },
      { name: 'Brandon Mechele', position: 'Defensor' },
      { name: 'Arthur Theate', position: 'Defensor' },
      { name: 'Maxim De Cuyper', position: 'Defensor' },
      { name: 'Thomas Meunier', position: 'Defensor' },
      { name: 'Nathan Ngoy', position: 'Defensor' },
      { name: 'Joaquin Seys', position: 'Defensor' },
      { name: 'Kevin De Bruyne', position: 'Atacante' },
      { name: 'Amadou Onana', position: 'Atacante' },
      { name: 'Nicolas Raskin', position: 'Atacante' },
      { name: 'Youri Tielemans', position: 'Atacante' },
      { name: 'Hans Vanaken', position: 'Atacante' },
      { name: 'Axel Witsel', position: 'Atacante' },
      { name: 'Charles De Ketelaere', position: 'Atacante' },
      { name: 'Mathias Fernandez-Pardo', position: 'Atacante' },
      { name: 'Jeremy Doku', position: 'Atacante' },
      { name: 'Romelu Lukaku', position: 'Atacante' },
      { name: 'Alexis Saelemaekers', position: 'Atacante' },
      { name: 'Leandro Trossard', position: 'Atacante' },
      { name: 'Dodi Lukebakio', position: 'Atacante' },
      { name: 'Diego Moreira', position: 'Atacante' }
    ],
    historyStats: {
      participations: 15,
      totalMatches: 51,
...
* ⚽ **Ataque e Defesa:** A equipe marcou 20 gols — nove deles do astro Mohamed Salah — e sofreu apenas dois, simbolizando a retomada do Egito rumo à elite do futebol mundial. 🛡️🌪️`,
    ...
    players: [
      { name: 'Mohamed El Shenawy', position: 'Goleiro' },
      { name: 'Mostafa Shobeir', position: 'Goleiro' },
      { name: 'El Mahdy Soliman', position: 'Goleiro' },
      { name: 'Mohamed Alaa', position: 'Goleiro' },
      { name: 'Mohamed Hany', position: 'Defensor' },
      { name: 'Tarek Alaa', position: 'Defensor' },
      { name: 'Hamdi Fathi', position: 'Defensor' },
      { name: 'Ramy Rabia', position: 'Defensor' },
      { name: 'Yasser Ibrahim', position: 'Defensor' },
      { name: 'Hossam Abdelmaguid', position: 'Defensor' },
      { name: 'Mohamed Abdelmonem', position: 'Defensor' },
      { name: 'Ahmed Fatouh', position: 'Defensor' },
      { name: 'Karim Hafez', position: 'Defensor' },
      { name: 'Marwan Attia', position: 'Atacante' },
      { name: 'Mohannad Lasheen', position: 'Atacante' },
      { name: 'Nabil Emad Dunga', position: 'Atacante' },
      { name: 'Mahmoud Saber', position: 'Atacante' },
      { name: 'Ahmed Sayed Zizo', position: 'Atacante' },
      { name: 'Mahmoud Trezeguet', position: 'Atacante' },
      { name: 'Emam Ashour', position: 'Atacante' },
      { name: 'Mostafa Ziko', position: 'Atacante' },
      { name: 'Ibrahim Adel', position: 'Atacante' },
      { name: 'Haitham Hassan', position: 'Atacante' },
      { name: 'Mohamed Salah', position: 'Atacante' },
      { name: 'Omar Marmoush', position: 'Atacante' },
      { name: 'Hamza Abdel Karim', position: 'Atacante' }
    ],
    historyStats: {
      participations: 4,
      totalMatches: 7,
...
* 📈 **Domínio:** Vencendo seis dos seus primeiros oito jogos na terceira fase, confirmou a vaga com antecedência. 🛡️🌪️`,
    ...
    players: [
      { name: 'Alireza Beyranvand', position: 'Goleiro' },
      { name: 'Hosein Hoseini', position: 'Goleiro' },
      { name: 'Payam Niazmand', position: 'Goleiro' },
      { name: 'Shoja Khalilzadeh', position: 'Defensor' },
      { name: 'Hosein Kanaani', position: 'Defensor' },
      { name: 'Ali Nemati', position: 'Defensor' },
      { name: 'Daniyal Eiri', position: 'Defensor' },
      { name: 'Ehsan Hajisafi', position: 'Defensor' },
      { name: 'Milad Mohammadi', position: 'Defensor' },
      { name: 'Saleh Hardani', position: 'Defensor' },
      { name: 'Ramin Rezaeiyan', position: 'Defensor' },
      { name: 'Saman Ghodoos', position: 'Atacante' },
      { name: 'Saeid Ezatollahi', position: 'Atacante' },
      { name: 'Rouzbeh Cheshmi', position: 'Atacante' },
      { name: 'Amir Mohammad Razagah Niya', position: 'Atacante' },
      { name: 'Mohammad Ghorbani', position: 'Atacante' },
      { name: 'Mehdi Ghayedi', position: 'Atacante' },
      { name: 'Ariya Yousefi', position: 'Atacante' },
      { name: 'Alireza Jahanbakhsh', position: 'Atacante' },
      { name: 'Mehdi Torabi', position: 'Atacante' },
      { name: 'Mohammad Mohebbi', position: 'Atacante' }
    ],
    historyStats: {
      participations: 7,
      totalMatches: 18,
...
* 🛡️ **Favoritismo Confirmado:** A equipe mostrou que era o time a ser batido na região, garantindo a primeira vaga direta da história da Oceania. 🇳🇿💪`,
    ...
    players: [
      { name: 'Max Crocombe', position: 'Goleiro' },
      { name: 'Alex Paulsen', position: 'Goleiro' },
      { name: 'Michael Woud', position: 'Goleiro' },
      { name: 'Tyler Bindon', position: 'Defensor' },
      { name: 'Michael Boxall', position: 'Defensor' },
      { name: 'Liberato Cacace', position: 'Defensor' },
      { name: 'Francis de Vries', position: 'Defensor' },
      { name: 'Callan Elliot', position: 'Defensor' },
      { name: 'Tim Payne', position: 'Defensor' },
      { name: 'Nando Pijnaker', position: 'Defensor' },
      { name: 'Tommy Smith', position: 'Defensor' },
      { name: 'Finn Surman', position: 'Defensor' },
      { name: 'Lachlan Bayliss', position: 'Atacante' },
      { name: 'Joe Bell', position: 'Atacante' },
      { name: 'Matt Garbett', position: 'Atacante' },
      { name: 'Ben Old', position: 'Atacante' },
      { name: 'Alex Rufer', position: 'Atacante' },
      { name: 'Sarpreet Singh', position: 'Atacante' },
      { name: 'Marko Stamenic', position: 'Atacante' },
      { name: 'Ryan Thomas', position: 'Atacante' },
      { name: 'Kosta Barbarouses', position: 'Atacante' },
      { name: 'Eli Just', position: 'Atacante' },
      { name: 'Callum McCowatt', position: 'Atacante' },
      { name: 'Jesse Randall', position: 'Atacante' },
      { name: 'Ben Waine', position: 'Atacante' },
      { name: 'Chris Wood', position: 'Atacante' }
    ],
    historyStats: {
      participations: 3,
      totalMatches: 6,
...
A República Democrática do Congo retorna ao Mundial após **52 anos** (sua única participação foi em 1974, como Zaire). Conhecidos como os **"Leopardos"**, a equipe vive um momento de ressurgimento no cenário africano.`,
    ...
    players: [
      { name: 'Timothy Fayulu', position: 'Goleiro' },
      { name: 'Lionel Mpasi', position: 'Goleiro' },
      { name: 'Matthieu Epolo', position: 'Goleiro' },
      { name: 'Aaron Wan-Bissaka', position: 'Defensor' },
      { name: 'Gédéon Kalulu', position: 'Defensor' },
      { name: 'Joris Kayembe', position: 'Defensor' },
      { name: 'Arthur Masuaku', position: 'Defensor' },
      { name: 'Steve Kapuadi', position: 'Defensor' },
      { name: 'Rocky Bushiri', position: 'Defensor' },
      { name: 'Axel Tuanzebe', position: 'Defensor' },
      { name: 'Chancel Mbemba', position: 'Defensor' },
      { name: 'Dylan Batubinsika', position: 'Defensor' },
      { name: 'Noah Sadiki', position: 'Atacante' },
      { name: 'Samuel Moutoussamy', position: 'Atacante' },
      { name: 'Edo Kayembe', position: 'Atacante' },
      { name: 'Ngal\'ayel Mukau', position: 'Atacante' },
      { name: 'Charles Pickel', position: 'Atacante' },
      { name: 'Nathanael Mbuku', position: 'Atacante' },
      { name: 'Brian Cipenga', position: 'Atacante' },
      { name: 'Theo Bongonda', position: 'Atacante' },
      { name: 'Gael Kakuta', position: 'Atacante' },
      { name: 'Meschack Elia', position: 'Atacante' },
      { name: 'Fiston Mayele', position: 'Atacante' },
      { name: 'Cédric Bakambu', position: 'Atacante' },
      { name: 'Simon Banza', position: 'Atacante' },
      { name: 'Yoane Wissa', position: 'Atacante' }
    ],
    historyStats: {
      participations: 2,
      totalMatches: 3,
...
Portugal chega à sua **9ª participação** em Mundiais com uma das gerações mais talentosas de sua história. Sob o comando de Roberto Martínez, a equipe busca o título inédito para coroar a carreira de Cristiano Ronaldo e consolidar seu status de potência global.`,
    ...
    players: [
      ...
      { name: 'José Sá', position: 'Goleiro' },
      { name: 'Rui Silva', position: 'Goleiro' },
      { name: 'Ricardo Velho', position: 'Goleiro' },
      { name: 'Diogo Dalot', position: 'Defensor' },
      { name: 'Matheus Nunes', position: 'Defensor' },
      { name: 'Nélson Semedo', position: 'Defensor' },
      { name: 'João Cancelo', position: 'Defensor' },
      { name: 'Nuno Mendes', position: 'Defensor' },
      { name: 'Gonçalo Inácio', position: 'Defensor' },
      { name: 'Renato Veiga', position: 'Defensor' },
      { name: 'Rúben Dias', position: 'Defensor' },
      { name: 'Tomás Araújo', position: 'Defensor' },
      { name: 'Rúben Neves', position: 'Atacante' },
      { name: 'Samuel Costa', position: 'Atacante' },
      { name: 'João Neves', position: 'Atacante' },
      { name: 'Vitinha', position: 'Atacante' },
      { name: 'Bruno Fernandes', position: 'Atacante' },
      { name: 'Bernardo Silva', position: 'Atacante' },
      { name: 'João Félix', position: 'Atacante' },
      { name: 'Trincão', position: 'Atacante' },
      { name: 'Francisco Conceição', position: 'Atacante' },
      { name: 'Pedro Neto', position: 'Atacante' },
      { name: 'Rafael Leão', position: 'Atacante' },
      { name: 'Gonçalo Guedes', position: 'Atacante' },
...
O Uzbequistão faz sua **estreia histórica** em Copas do Mundo. Após bater na trave em várias eliminatórias, a seleção da Ásia Central finalmente garantiu seu lugar entre os melhores do mundo.`,
    ...
    players: [
      { name: 'Otkir Yusupov', position: 'Goleiro' },
      { name: 'Abduvohid Nematov', position: 'Goleiro' },
      { name: 'Botirali Ergashev', position: 'Goleiro' },
      { name: 'Abdukodir Husanov', position: 'Defensor' },
      { name: 'Hojiakbar Alijonov', position: 'Defensor' },
      { name: 'Farruh Sayfiyev', position: 'Defensor' },
      { name: 'Rustam Ashurmatov', position: 'Defensor' },
      { name: 'Umar Eshmurodov', position: 'Defensor' },
      { name: 'Sherzod Nasrullayev', position: 'Defensor' },
      { name: 'Abdulla Abdullayev', position: 'Defensor' },
      { name: 'Avazbek Olmasaliyev', position: 'Defensor' },
      { name: 'Jahongir Orozov', position: 'Defensor' },
      { name: 'Behruz Karimov', position: 'Defensor' },
      { name: 'Akmal Mozgovoy', position: 'Atacante' },
      { name: 'Otabek Shukurov', position: 'Atacante' },
      { name: 'Jamshid Iskanderov', position: 'Atacante' },
      { name: 'Odil Hamrobekov', position: 'Atacante' },
      { name: 'Jaloliddin Masharipov', position: 'Atacante' },
      { name: 'Oston O\'runov', position: 'Atacante' },
      { name: 'Dostonbek Hamdamov', position: 'Atacante' },
      { name: 'Aziz G\'aniyev', position: 'Atacante' },
      { name: 'Abbosbek Fayzullayev', position: 'Atacante' },
      { name: 'Sherzod Esanov', position: 'Atacante' },
      { name: 'Eldor Shomurodov', position: 'Atacante' },
      { name: 'Igor Sergeyev', position: 'Atacante' },
      { name: 'Azizbek Omonov', position: 'Atacante' }
    ],
    historyStats: {
      participations: 1,
      totalMatches: 0,
...
A Colômbia retorna ao Mundial com uma equipe renovada e cheia de talento. Sob o comando de Néstor Lorenzo, a "Tricolor" busca repetir a campanha histórica de 2014 e encantar o mundo com seu futebol alegre e ofensivo.`,
    ...
    players: [
      { name: 'Camilo Vargas', position: 'Goleiro' },
      { name: 'Alvaro Montero', position: 'Goleiro' },
      { name: 'David Ospina', position: 'Goleiro' },
      { name: 'Davinson Sánchez', position: 'Defensor' },
      { name: 'Jhon Lucumí', position: 'Defensor' },
      { name: 'Yerry Mina', position: 'Defensor' },
      { name: 'Daniel Muñoz', position: 'Defensor' },
      { name: 'Willer Ditta', position: 'Defensor' },
      { name: 'Santiago Arias', position: 'Defensor' },
      { name: 'Johan Mojica', position: 'Defensor' },
      { name: 'Deiver Machado', position: 'Defensor' },
      { name: 'Richard Ríos', position: 'Atacante' },
      { name: 'Jefferson Lerma', position: 'Atacante' },
      { name: 'Kevin Castaño', position: 'Atacante' },
      { name: 'Gustavo Puerta', position: 'Atacante' },
      { name: 'Jhon Arias', position: 'Atacante' },
      { name: 'Jorge Carrascal', position: 'Atacante' },
      { name: 'Juan Portilla', position: 'Atacante' },
      { name: 'Juan Quintero', position: 'Atacante' },
      { name: 'James Rodríguez', position: 'Atacante' },
      { name: 'Jaminton Campaz Cucho Hernández', position: 'Atacante' },
      { name: 'Luis Díaz', position: 'Atacante' },
      { name: 'Luis Suárez', position: 'Atacante' },
      { name: 'Andrés Gómez', position: 'Atacante' },
      { name: 'Jhon Córdoba', position: 'Atacante' }
    ],
    historyStats: {
      participations: 7,
      totalMatches: 22,
...
A Inglaterra chega ao Mundial de 2026 com a missão de finalmente "trazer o futebol para casa". Sob o comando de Thomas Tuchel, os "Three Lions" ostentam um dos elencos mais valiosos e talentosos do planeta, combinando a experiência de Harry Kane com a genialidade jovem de Jude Bellingham e Phil Foden.`,
    ...
    players: [
      ...
      { name: 'Dean Henderson', position: 'Goleiro' },
      { name: 'James Trafford', position: 'Goleiro' },
      { name: 'Reece James', position: 'Defensor' },
      { name: 'Ezri Konsa', position: 'Defensor' },
      { name: 'Jarell Quansah', position: 'Defensor' },
      { name: 'John Stones', position: 'Defensor' },
      { name: 'Marc Guehi', position: 'Defensor' },
      { name: 'Dan Burn', position: 'Defensor' },
      { name: 'Nico O\'Reilly', position: 'Defensor' },
      { name: 'Djed Spence', position: 'Defensor' },
      { name: 'Tino Livramento', position: 'Defensor' },
      { name: 'Declan Rice', position: 'Atacante' },
      { name: 'Elliot Anderson', position: 'Atacante' },
      { name: 'Kobbie Mainoo', position: 'Atacante' },
      { name: 'Jordan Henderson', position: 'Atacante' },
      { name: 'Morgan Rogers', position: 'Atacante' },
      { name: 'Jude Bellingham', position: 'Atacante' },
      { name: 'Eberechi Eze', position: 'Atacante' },
      { name: 'Harry Kane', position: 'Atacante' },
      { name: 'Ivan Toney', position: 'Atacante' },
      { name: 'Ollie Watkins', position: 'Atacante' },
      { name: 'Bukayo Saka', position: 'Atacante' },
      { name: 'Marcus Rashford', position: 'Atacante' },
      { name: 'Anthony Gordon', position: 'Atacante' },
      { name: 'Noni Madueke', position: 'Atacante' }
    ],
    historyStats: {
      participations: 17,
      totalMatches: 74,
...
A Croácia, pequena em território mas gigante em campo, chega para sua **7ª participação** em Mundiais. Conhecida por sua resiliência e meio-campo magistral, a seleção croata busca manter-se entre as melhores do mundo após o vice-campeonato em 2018 e o terceiro lugar em 2022.`,
    ...
    players: [
      { name: 'Dominik Livakovic', position: 'Goleiro' },
      { name: 'Dominik Kotarski', position: 'Goleiro' },
      { name: 'Ivor Pandur', position: 'Goleiro' },
      { name: 'Josko Gvardiol', position: 'Defensor' },
      { name: 'Duje Caleta-Car', position: 'Defensor' },
      { name: 'Josip Sutalo', position: 'Defensor' },
      { name: 'Josip Stanisic', position: 'Defensor' },
      { name: 'Marin Pongracic', position: 'Defensor' },
      { name: 'Martin Erlic', position: 'Defensor' },
      { name: 'Luka Vuskovic', position: 'Defensor' },
      { name: 'Luka Modric', position: 'Atacante' },
      { name: 'Mateo Kovacic', position: 'Atacante' },
      { name: 'Mario Pasalic', position: 'Atacante' },
      { name: 'Nikola Vlasic', position: 'Atacante' },
      { name: 'Luka Sucic', position: 'Atacante' },
      { name: 'Martin Baturina', position: 'Atacante' },
      { name: 'Kristijan Jakic', position: 'Atacante' },
      { name: 'Petar Sucic', position: 'Atacante' },
      { name: 'Nikola Moro', position: 'Atacante' },
      { name: 'Toni Fruk', position: 'Atacante' },
      { name: 'Ivan Perisic', position: 'Atacante' },
      { name: 'Andrej Kramaric', position: 'Atacante' },
      { name: 'Ante Budimir', position: 'Atacante' },
      { name: 'Marco Pasalic', position: 'Atacante' },
      { name: 'Petar Musa', position: 'Atacante' },
      { name: 'Igor Matanovic', position: 'Atacante' }
    ],
    historyStats: {
      participations: 7,
      totalMatches: 30,
...
Os "Black Stars" de Gana retornam ao Mundial com o objetivo de repetir a campanha histórica de 2010. Com uma mistura de veteranos experientes e jovens talentos que brilham na Europa, a seleção ganesa promete ser uma das equipes mais vibrantes do torneio.`,
    ...
    players: [
      { name: 'Benjamin Asare', position: 'Goleiro' },
      { name: 'Lawrence Ati-Zigi', position: 'Goleiro' },
      { name: 'Joseph Anang', position: 'Goleiro' },
      { name: 'Baba Abdul Rahman', position: 'Defensor' },
      { name: 'Gideoh Mensah', position: 'Defensor' },
      { name: 'Marvin Senaya', position: 'Defensor' },
      { name: 'Alidu Seidu', position: 'Defensor' },
      { name: 'Abdul Mumin', position: 'Defensor' },
      { name: 'Jerome Opoku', position: 'Defensor' },
      { name: 'Jonas Adjetey', position: 'Defensor' },
      { name: 'Kojo Oppong Peprah', position: 'Defensor' },
      { name: 'Derrick Luckassen', position: 'Defensor' },
      { name: 'Elisha Owusu', position: 'Atacante' },
      { name: 'Thomas Partey', position: 'Atacante' },
      { name: 'Kwasi Sibo', position: 'Atacante' },
      { name: 'Augustine Boakye', position: 'Atacante' },
      { name: 'Caleb Yirenkyi', position: 'Atacante' },
      { name: 'Abdul Fatawu Issahaku', position: 'Atacante' },
      { name: 'Christopher Bonsu Baah', position: 'Atacante' },
      { name: 'Ernest Nuamah', position: 'Atacante' },
      { name: 'Antoine Semenyo', position: 'Atacante' },
      { name: 'Brandon Thomas-Asante', position: 'Atacante' },
      { name: 'Kamal Deen Sulemana', position: 'Atacante' },
      { name: 'Prince Kwabena Adu', position: 'Atacante' },
      { name: 'Iñaki Williams', position: 'Atacante' },
      { name: 'Jordan Ayew', position: 'Atacante' }
    ],
    historyStats: {
      participations: 5,
      totalMatches: 15,
...
O Panamá chega à sua **2ª participação** em Mundiais após uma campanha histórica nas eliminatórias da CONCACAF. Conhecidos como "Los Canaleros", a equipe busca sua primeira vitória em Copas e quer mostrar a evolução do futebol panamenho no cenário global.`,
    ...
    players: [
      { name: 'Orlando Mosquera', position: 'Goleiro' },
      { name: 'Luis Mejía', position: 'Goleiro' },
      { name: 'César Samudio', position: 'Goleiro' },
      { name: 'César Blackman', position: 'Defensor' },
      { name: 'Jorge Gutiérrez', position: 'Defensor' },
      { name: 'Amir Murillo', position: 'Defensor' },
      { name: 'Fidel Escobar', position: 'Defensor' },
      { name: 'Andrés Andrade', position: 'Defensor' },
      { name: 'Edgardo Fariña', position: 'Defensor' },
      { name: 'José Córdoba', position: 'Defensor' },
      { name: 'Eric David', position: 'Defensor' },
      { name: 'Jiovany Ramos', position: 'Defensor' },
      { name: 'Roderick Miller', position: 'Defensor' },
      { name: 'Aníbal Godoy', position: 'Atacante' },
      { name: 'Adalberto Carrasquilla', position: 'Atacante' },
      { name: 'Carlos Harvey', position: 'Atacante' },
      { name: 'Cristian Martínez', position: 'Atacante' },
      { name: 'José Luis Rodríguez', position: 'Atacante' },
      { name: 'César Yanis', position: 'Atacante' },
      { name: 'Yoel Bárcenas', position: 'Atacante' },
      { name: 'Alberto Quintero', position: 'Atacante' },
      { name: 'Azarías Londoño', position: 'Atacante' },
      { name: 'Ismael Díaz', position: 'Atacante' },
      { name: 'Cecilio Waterman', position: 'Atacante' },
      { name: 'José Fajardo', position: 'Atacante' },
      { name: 'Tomás Rodríguez', position: 'Atacante' }
    ],
    historyStats: {
      participations: 2,
      totalMatches: 3,
