...
A meta é clara: voltar ao mata-mata, algo que não acontece desde 1994.`,
    ...
    players: [
      ...
      { name: 'Firas Al-Buraikan', position: 'Atacante', club: 'Al-Ahli', highlight: 'Jovem artilheiro que se consolidou como a principal referência no ataque saudita.', image: 'https://img.sofascore.com/api/v1/player/893307/image' },
      { name: 'Saud Abdulhamid', position: 'Lateral', club: 'RC Lens', highlight: 'Primeiro saudita a atuar em uma das grandes ligas europeias, trazendo experiência internacional.', image: 'https://img.sofascore.com/api/v1/player/966849/image' }
    ],
    historyStats: {
      participations: 7,
      totalMatches: 19,
...
* **Principais Conquistas:** Conduziu a Suíça a campanhas sólidas em Eurocopas e Copas do Mundo, sendo reconhecido por sua organização tática.`,
    ...
    players: [
      ...
      { name: 'Mohamed Amoura', position: 'Atacante', club: 'Wolfsburg', highlight: 'Jovem artilheiro veloz que se tornou a principal arma ofensiva nas eliminatórias.', image:'https://img.sofascore.com/api/v1/player/1107591/image' },
      { name: 'Ismaël Bennacer', position: 'Meia', club: 'Dinamo Zagreb', highlight: 'O motor do meio-campo, essencial na transição entre defesa e ataque.', image:'https://img.sofascore.com/api/v1/player/823733/image' }
    ],
    historyStats: {
      participations: 5,
      totalMatches: 13,
...
* **Principais Conquistas:** Pioneiro do *Gegenpressing*, influenciou gerações de treinadores alemães e transformou o estilo de jogo da Áustria com intensidade e pressão alta.`,
    ...
    players: [
      ...
      { name: 'Konrad Laimer', position: 'Meia', club: 'Bayern Munich', highlight: 'Especialista em pressão e recuperação de bola, essencial no esquema de Rangnick.', image:'https://img.sofascore.com/api/v1/player/355492/image' },
      { name: 'Christoph Baumgartner', position: 'Meia', club: 'RB Leipzig', highlight: 'Talento criativo que traz imprevisibilidade ao ataque austríaco.', image:'https://img.sofascore.com/api/v1/player/825956/image' }
    ],
    historyStats: {
      participations: 8,
      totalMatches: 29,
...
👉 Objetivo: avançar e fazer sua melhor campanha da história.`,
    ...
    players: [
      ...
      { name: 'Martin Ødegaard', position: 'Meia', club: 'Arsenal', highlight: 'Capitão e cérebro da equipe, responsável por ditar o ritmo e criar chances.', image:'https://img.sofascore.com/api/v1/player/547410/image' },
      { name: 'Alexander Sørloth', position: 'Atacante', club: 'Atlético Madrid', highlight: 'Poder físico e presença de área, excelente complemento para Haaland no ataque.', image:'https://img.sofascore.com/api/v1/player/309078/image' }
    ],
    historyStats: {
      participations: 4,
      totalMatches: 8,
...
A República Democrática do Congo retorna ao Mundial após **52 anos** (sua única participação foi em 1974, como Zaire). Conhecidos como os **"Leopardos"**, a equipe vive um momento de ressurgimento no cenário africano.`,
    ...
    players: [
      { name: 'Chancel Mbemba', position: 'Zagueiro', club: 'Lille', highlight: 'Líder e capitão, traz experiência e segurança para a defesa.', image:'https://img.sofascore.com/api/v1/player/238612/image' },
      { name: 'Yoane Wissa', position: 'Atacante', club: 'Newcastle United', highlight: 'Velocidade e faro de gol, principal arma ofensiva na Premier League.', image:'https://img.sofascore.com/api/v1/player/805123/image' },
      { name: 'Simon Banza', position: 'Atacante', club: 'Al-Jazira', highlight: 'Centroavante potente e excelente finalizador.', image:'https://img.sofascore.com/api/v1/player/825945/image' }
    ],
    historyStats: {
      participations: 2,
      totalMatches: 3,
...
O Uzbequistão faz sua **estreia histórica** em Copas do Mundo. Após bater na trave em várias eliminatórias, a seleção da Ásia Central finalmente garantiu seu lugar entre os melhores do mundo.`,
    ...
    players: [
      { name: 'Eldor Shomurodov', position: 'Atacante', club: 'Başakşehir FK', highlight: 'Capitão e maior referência ofensiva, com vasta experiência no futebol europeu.', image:'https://img.sofascore.com/api/v1/player/791355/image' },
      { name: 'Abbosbek Fayzullaev', position: 'Meia', club: 'Başakşehir FK', highlight: 'Jovem talento criativo e habilidoso, a grande promessa do país.', image:'https://img.sofascore.com/api/v1/player/1118429/image' },
      { name: 'Jaloliddin Masharipov', position: 'Meia', club: 'Esteghlal', highlight: 'Experiência e qualidade técnica na armação das jogadas.', image:'https://img.sofascore.com/api/v1/player/333611/image' }
    ],
    historyStats: {
      participations: 1,
      totalMatches: 0,
...
A Colômbia retorna ao Mundial com uma equipe renovada e cheia de talento. Sob o comando de Néstor Lorenzo, a "Tricolor" busca repetir a campanha histórica de 2014 e encantar o mundo com seu futebol alegre e ofensivo.`,
    ...
    players: [
      { name: 'Luis Díaz', position: 'Atacante', club: 'Bayern München', highlight: 'Um dos melhores pontas do mundo, velocidade e drible que desequilibram qualquer defesa.', image:'https://img.sofascore.com/api/v1/player/883537/image' },
      { name: 'James Rodríguez', position: 'Meia', club: 'Minnesota United', highlight: 'O capitão e cérebro do time, com visão de jogo e passes magistrais.', image:'https://img.sofascore.com/api/v1/player/107414/image' },
      { name: 'Jhon Durán', position: 'Atacante', club: 'Zenit', highlight: 'Jovem centroavante potente e em grande fase na Premier League.', image:'https://img.sofascore.com/api/v1/player/974577/image' }
    ],
    historyStats: {
      participations: 7,
      totalMatches: 22,
...
A Croácia, pequena em território mas gigante em campo, chega para sua **7ª participação** em Mundiais. Conhecida por sua resiliência e meio-campo magistral, a seleção croata busca manter-se entre as melhores do mundo após o vice-campeonato em 2018 e o terceiro lugar em 2022.`,
    ...
    players: [
      ...
      { name: 'Joško Gvardiol', position: 'Zagueiro', club: 'Manchester City', highlight: 'Um dos melhores defensores do mundo, pilar da solidez defensiva croata.', image:'https://img.sofascore.com/api/v1/player/964994/image' },
      { name: 'Mateo Kovačić', position: 'Meia', club: 'Manchester City', highlight: 'Dinamismo e qualidade técnica essenciais para o controle do meio-campo.', image:'https://img.sofascore.com/api/v1/player/136710/image' }
    ],
    historyStats: {
      participations: 7,
      totalMatches: 30,
...
O Panamá chega à sua **2ª participação** em Mundiais após uma campanha histórica nas eliminatórias da CONCACAF. Conhecidos como "Los Canaleros", a equipe busca sua primeira vitória em Copas e quer mostrar a evolução do futebol panamenho no cenário global.`,
    ...
    players: [
      ...
      { name: 'José Córdoba', position: 'Zagueiro', club: 'Norwich City', highlight: 'Jovem promessa defensiva que se consolidou como pilar da zaga panamenha.', image:'https://img.sofascore.com/api/v1/player/1105688/image' }
    ],
    historyStats: {
      participations: 2,
      totalMatches: 3,
